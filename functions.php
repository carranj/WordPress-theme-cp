...
function theme_styles(){
	...
	wp_enqueue_style( 'royal-slider-skin', get_template_directory_uri() . '/royalslider/skins/coastalspray/rs-mh.css' );
...
create_widget( 'Social Footer Widget', 'social-footer-widget', 'Displays in the black portion of the footer' );
?>